...
namespace lib_presentaciones
{
    public class Comunicaciones
    {
        ...
        // Constructor que permite establecer servicio, protocolo y host
        public Comunicaciones(string servicio = "",
            //Estos campos se establecen por defecto en el constructor ya que el protocolo y el host no cambian
            string protocolo = "http://",
            string host = "localhost:5156")//se coloca el puerto en el cual se ejecuta asp_servicios
        {
            Protocolo = protocolo;
            Host = host;
            Servicio = servicio;
        ...
        //Construye la url para la peticion de los 
